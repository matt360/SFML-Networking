...
protected:
	...
	virtual void addMessage(PlayerMessage& player_message_send, const Sprite& player, const sf::Clock& clock);
	// SEND (to the client)
	...
	void runUdpServer(const Sprite& player, const sf::Clock& clock, const bool& debug_mode);
};
