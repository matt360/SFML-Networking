...
protected:
	...
	void keepTrackOfLinearLocalPositoins(const Player& player, const sf::Int32& time);
	...
	void linearInterpolation(Player& player, const sf::Int32& time, const bool& lerp_mode);
};
