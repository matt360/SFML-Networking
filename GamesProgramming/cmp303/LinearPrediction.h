...
public:
	...
	sf::Vector2f linearInterpolation(Sprite & sprite, sf::Vector2f & msg0_local_position, sf::Vector2f & msg1_local_position, sf::Vector2f & msg0_network_position, sf::Vector2f & msg1_network_position, float & msg0_time, float & msg1_time, const sf::Int32 & tm, const bool & lerp_mode);
protected:
	sf::Vector2f predictLinearLocalPath(sf::Vector2f & msg0_local_position, sf::Vector2f & msg1_local_position, float & msg0_time, float & msg1_time, float & time);
